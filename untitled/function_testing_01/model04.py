...
l.driver.find_element_by_xpath('//div[@class="layui-btn-container"]/button[@lay-event="printStatement2"]').click()    #结算明细打印
xf2 = l.driver.find_element_by_xpath("//div[@class='layui-layer-content']/iframe[@src='./printmonthlyreconciliationsettlement.html']")
